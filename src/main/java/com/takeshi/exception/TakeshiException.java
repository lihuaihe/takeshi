...
public class TakeshiException extends RuntimeException {
     ...
     * @param metaData 附加数据
     */
    public TakeshiException(String message, Object metaData) {
     ...
     * @param metaData 附加数据
     */
    public TakeshiException(int code, String message, Object metaData) {
     ...
     * @param metaData 附加数据
     */
    public TakeshiException(RetBO retBO, Object metaData) {
     ...
     * @param args     将为消息中的参数填充的参数数组（参数在消息中类似于“{0}”、“{1,date}”、“{2,time}”），如果没有则为null
     */
    public TakeshiException(RetBO retBO, Object metaData, Object... args) {
    ...
    public static Supplier<TakeshiException> supplier(String message, Object metaData) {
        return () -> new TakeshiException(message, metaData);
    }
     ...
     * @return Supplier
     */
    public static Supplier<TakeshiException> supplier(int code, String message, Object metaData) {
        return () -> new TakeshiException(code, message, metaData);
    }
     ...
     * @return Supplier
     */
    public static Supplier<TakeshiException> supplier(RetBO retBO, Object metaData) {
        return () -> new TakeshiException(retBO, metaData);
    }
     ...
     * @return Supplier
     */
    public static Supplier<TakeshiException> supplier(RetBO retBO, Object metaData, Object... args) {
        return () -> new TakeshiException(retBO, metaData, args);
    }
